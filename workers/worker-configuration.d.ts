/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/wrangler.jsonc workers/worker-configuration.d.ts` (hash: 404bf1655ce992d333c0a165d9722cb3)
// Runtime types generated with workerd@1.20260630.1 2026-07-01 
interface __BaseEnv_Env {
	DB: D1Database;
	ALLOWED_ORIGINS: "http://localhost:5173,http://127.0.0.1:5173,https://pajcho.github.io";
	VAPID_PUBLIC_KEY: "BGTd77Cah8f6AB7xUaoYrsPBT_Y7uc8ebc8Yz0qcjee-kNK6OGLmG4wO0rLoPH54LhPQwXGZIq5Swsp6dSIeRuk";
	VAPID_SUBJECT: "mailto:nikola.pajic@gmail.com";
	APP_BASE_URL: "https://pajcho.github.io/preferans";
	AUTH_SECRET: string;
	DEBUG_API: string;
	ADMIN_TOKEN: string;
